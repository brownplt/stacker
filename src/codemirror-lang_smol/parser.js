...
const spec_Identifier = {__proto__:null,defgen:8, deffun:10, defvar:12, yield:14, while:16, "set!":18, if:20, let:22, cond:24, else:26, begin:28, lambda:30, "λ":32}
export const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ LineComment Program Identifier defgen deffun defvar yield while set! if let cond else begin lambda λ String Boolean ) ( Application ] [ Application",
  maxTerm: 29,
  nodeProps: [
    ["openedBy", 19,"(",22,"["],
    ["closedBy", 20,")",23,"]"]
